...
import tacoscloudreactive.domain.Ingredient.Type;
...
public class DesignTacoController
{
    ...
    /*WebFlux BUG: 添加@Valid的@ModelAttribute无法指定name. 需使用与类名相同的名称,否则不显示错误信息.*/
    @PostMapping
    public String processDesign(@ModelAttribute("order") Order order, @Valid @ModelAttribute Taco taco, Errors errors)
    {
        if (errors.hasErrors()) {
            return "design";
        }
